...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.container1', '2020-11-12');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function () {
      ...
      postData('assets/server.php', formData).then(function (res) {
        console.log(res);
        status.message.textContent = message.success;
      }).catch(function () {
        return status.message.textContent = message.failure;
      }).finaly(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  function bindModal(modalTrigger, modalSelector, closeSelector) {
  ...
  function modalShowByTimout(selector, time) {
    setTimeout(function () {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // modalShowByTimout('.popup', 60000);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function timerGeneral(timerSelector, deadline) {
  ...
  function setClock(timerSelector, deadline) {
    var selector = document.querySelector(timerSelector),
...
/* harmony default export */ __webpack_exports__["default"] = (timerGeneral);
